...
export default function Card({nome, email, setor, 
  chefe, avaliar, historicoBotao, apagarBotao, botao1, botao2,botao3, botao4, voltar}){
    return(
        <>
      ...
      <div className="our_solution_category">
        <div className="solution_cards_box">
          <div className="solution_card">
            ...
            <p>Email: {email}</p>
            <p>Setor: {setor}</p>
            <p>Responsável: {chefe}</p>

           {botao1&&<button type="button" className="btn btn-primary mt-3" >{botao1}</button>}
