...
export default function Canva(){
    return(<>
        <section className="canvaContainer container w-100 mb-3">
            ...
            <div className="row">
                <div className="customBorder col-2 d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col-3 d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder col d-flex justify-content-center align-items-center">Teste</div>
                <div className="customBorder2 col d-flex justify-content-center align-items-center" >Teste</div>
             </div>

             <div className="row">
                <div className="customBorder3 col-2 ">Teste</div>
                <div className="customBorder3 col-3 ">Teste</div>
