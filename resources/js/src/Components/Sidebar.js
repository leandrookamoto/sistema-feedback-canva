...
export default function Sidebar({
  ...
  return (
    <section className="sidebar d-flex flex-column">
      ...
      <div
        className={homeRender?"d-flex mt-2 home escolhido":"d-flex mt-2 home"}
      ...
      >
        ...
        <div className={homeRender?"ml-3 home escolhido":"ml-3 home"}>Home</div>
      </div>

      {/* Parte responsável pela renderização do componente de cadastro */}
      <div
        className={cadastrar?"d-flex mt-2 home escolhido":"d-flex mt-2 home"}
        style={{ marginLeft: '50px' }}
      ...
      >
        ...
        <div className={cadastrar?"ml-3 home escolhido":"ml-3 home"}>Cadastrar funcionário</div>
      </div>
      ...
      >
        ...
        <div className={feedback?"ml-3 home escolhido":"ml-3 home"}>Feedback</div>
      </div>

      {/* Parte responsável pela renderização dos pendentes */}
      <div
        className={pendentes?"d-flex mt-2 home escolhido":"d-flex mt-2 home"}
        style={{ marginLeft: '50px' }}
      ...
      >
        ...
        <div className={pendentes?"ml-3 home escolhido":"ml-3 home"}>Pendentes</div>
      </div>
    </section>
  );
}
