...
export default function Card({nomeFuncionario, emailFuncionario, setorFuncionario, 
  chefeFuncionario, avaliarBotao, historicoBotao, apagarBotao, botao1, botao2,botao3, botao4, voltar}){
    return(
        <>
      ...
      <div className="our_solution_category">
        <div className="solution_cards_box">
          <div className="solution_card">
            ...
            <p>Email: {emailFuncionario}</p>
            <p>Setor: {setorFuncionario}</p>
            <p>Responsável: {chefeFuncionario}</p>

           {botao1&&<button type="button" className="btn btn-primary mt-3" onClick={avaliarBotao}>{botao1}</button>}
           {botao2&&<button type="button" className="btn btn-primary ml-3 mt-3" onClick={historicoBotao}>{botao2}</button>}
           {botao3&&<button type="button" className="btn btn-primary ml-3 mt-3" onClick={apagarBotao}>{botao3}</button>}
           {botao4&&<button type="button" className="btn btn-primary ml-3 mt-3" onClick={voltar}>{botao4}</button>}
            </div>
          </div>
